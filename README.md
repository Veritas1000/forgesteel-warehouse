...
| `JWT_COOKIE_SECURE` | `True` | [Reference](https://flask-jwt-extended.readthedocs.io/en/stable/options.html#jwt-cookie-secure) |
| `JWT_COOKIE_SAMESITE` | `Strict` | [Reference](https://flask-jwt-extended.readthedocs.io/en/stable/options.html#JWT_COOKIE_SAMESITE) |
| `JWT_COOKIE_DOMAIN` | *None* | [Reference](https://flask-jwt-extended.readthedocs.io/en/stable/options.html#JWT_COOKIE_DOMAIN) |
